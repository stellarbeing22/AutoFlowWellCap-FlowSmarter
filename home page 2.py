...
def play_video(video_path, sound_path, text):
    ...
    try:
        font_path = 'balo.otf'  # Replace with your custom OTF font path
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if (mouse_x - circle_x) ** 2 + (mouse_y - circle_y) ** 2 <= circle_radius ** 2:
                    ...
                    script_path = r"C:\Users\Lenovo\PycharmProjects\tkinter\.venv\Scripts\Autoflow Well Cap\Uddham Singh Nagar Readings.py"  # Full path to the script you want to run
                    subprocess.run(
